...
RoutixをClaude Code CLIと統合し、AnthropicのAPIリクエストをRoutixのインテリジェントルーティングシステム経由でルーティングします。
...
Claude CodeはRoutixモデルにマッピングされる以下のモデルエイリアスをサポート:
