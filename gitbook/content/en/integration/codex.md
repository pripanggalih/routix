...
Integrate Routix with OpenAI Codex CLI to route your OpenAI API requests through Routix's intelligent routing system.
...
Routix provides the following Codex models:
...
1. Verify your API key is correct in Routix dashboard
...
1. Verify the model name matches your Routix configuration
2. Check that the OpenAI provider connection is active in Routix dashboard
...
Make sure you have configured your API key in the Routix cloud dashboard.
