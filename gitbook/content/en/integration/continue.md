...
Integrate Routix with Continue extension to bring AI assistance directly into Visual Studio Code.

## Prerequisites

- Visual Studio Code installed
- Continue extension installed from VSCode marketplace
- Routix API key from [dashboard](https://routix.web.id/dashboard)
- Routix running (local or cloud)
...
### 2. Add Routix Model Configuration
...
3. Choose your preferred Routix model
...
- Check network latency to Routix
