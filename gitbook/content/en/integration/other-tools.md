...
Routix is compatible with any tool that supports the OpenAI API format. This guide covers generic integration patterns for various tools and custom applications.

## Overview

Routix provides an OpenAI-compatible API endpoint that works with:
...
Any OpenAI-compatible tool can connect to Routix using these settings:

**Local Routix:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: any Routix model (cc/*, cx/*, glm/*, etc.)
```
...
**Problem:** Cannot connect to Routix
```bash
...
- Check network connection to Routix
