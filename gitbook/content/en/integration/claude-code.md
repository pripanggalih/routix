...
Integrate Routix with Claude Code CLI to route your Anthropic API requests through Routix's intelligent routing system.
...
Claude Code supports the following model aliases that map to Routix models:
