...
Common questions about Routix.

---

## What is Routix?

**Routix is an AI model router that maximizes your subscription value and minimizes costs.**
...
**Routix uses a 3-tier pricing strategy:**
...
**Yes, Routix itself is 100% free and open source.**
...
**Yes! This is Routix's core feature.**
...
**Routix tracks quota in real-time for all providers:**
...
## Can I self-host Routix?

**Yes! Routix supports multiple deployment options:**
...
- `DATA_DIR` - Database storage path (default: `~/.routix`)
...
**Yes, Routix prioritizes security and privacy:**

**Local storage:**
- All data stored locally in `~/.routix` (or custom `DATA_DIR`)
- No data sent to Routix servers
...
**Breaking changes:**
- Check [CHANGELOG.md](https://github.com/pripanggalih/routix/blob/main/CHANGELOG.md)
- Backup `~/.routix` before major updates
...
See [CONTRIBUTING.md](https://github.com/pripanggalih/routix/blob/main/CONTRIBUTING.md) for details.
