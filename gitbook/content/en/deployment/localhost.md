...
Run Routix on your local machine for development and personal use.

---

## 📦 Installation

Install Routix globally via npm:
...
Start Routix with a single command:
...
Press `Ctrl+C` in the terminal where Routix is running.
