...
Deploy Routix on VPS or Docker for remote access and production use.
...
| `DATA_DIR` | `~/.routix` | Database and data storage path |
...
Create `/etc/nginx/sites-available/routix`:
