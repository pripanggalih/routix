...
Detailed installation guide for Routix with troubleshooting tips.
...
Install Routix globally to use from anywhere:
...
- ✅ Simple command: `routix`
- ✅ Auto-updates with `npm update -g routix`
...
3. Data directory created at `~/.routix`
...
**Issue:** Routix using too much RAM
