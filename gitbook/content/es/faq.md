...
Preguntas comunes sobre Routix.

---

## ¿Qué es Routix?

**Routix es un router de modelos de IA que maximiza el valor de tu suscripción y minimiza los costos.**
...
**Routix usa una estrategia de precios de 3 niveles:**
...
**Sí, Routix en sí es 100% gratis y open source.**
...
**¡Sí! Esta es la característica principal de Routix.**
...
**Routix rastrea la cuota en tiempo real para todos los proveedores:**
...
## ¿Routix funciona con Cursor?

**Sí, pero Cursor requiere un endpoint en la nube.**

**Problema:** Cursor IDE no soporta endpoints en localhost.

**Solución:** Usa el despliegue en la nube de Routix:

```
Cursor Settings → Models → Advanced:
  OpenAI API Base URL: https://routix.web.id/v1
...
## ¿Puedo auto-hospedar Routix?

**¡Sí! Routix soporta múltiples opciones de despliegue:**
...
- `DATA_DIR` - Ruta de almacenamiento de la base de datos (por defecto: `~/.routix`)
...
**Sí, Routix prioriza la seguridad y privacidad:**

**Almacenamiento local:**
- Todos los datos se almacenan localmente en `~/.routix` (o `DATA_DIR` personalizado)
- No se envían datos a los servidores de Routix
...
**Cambios disruptivos:**
- Revisa [CHANGELOG.md](https://github.com/pripanggalih/routix/blob/main/CHANGELOG.md)
- Respalda `~/.routix` antes de actualizaciones mayores
...
1. **Reportar bugs:**
   - [GitHub Issues](https://github.com/pripanggalih/routix/issues)
   - Incluye logs de error, pasos para reproducir

2. **Solicitar características:**
   - [GitHub Discussions](https://github.com/pripanggalih/routix/discussions)
   - Describe el caso de uso y los beneficios

3. **Enviar código:**
   ```bash
   # Fork del repo
   git clone https://github.com/YOUR_USERNAME/routix.git
   cd routix
...
Consulta [CONTRIBUTING.md](https://github.com/pripanggalih/routix/blob/main/CONTRIBUTING.md) para detalles.

---

## ¿Necesitas más ayuda?

- **Documentación:** [routix.web.id/docs](https://routix.web.id/docs)
