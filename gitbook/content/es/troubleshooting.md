...
Problemas comunes y soluciones al usar Routix.
...
1. **Refresh automático (por defecto):**
   Routix refresca automáticamente los tokens. Espera 30 segundos y reintenta.
...
1. **Verifica si Routix está ejecutándose:**
   ```bash
   # Verifica el proceso
   ps aux | grep routix
