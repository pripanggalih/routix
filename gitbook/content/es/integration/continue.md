...
Integra Routix con la extensión Continue para llevar la asistencia de IA directamente a Visual Studio Code.

## Requisitos previos

- Visual Studio Code instalado
- Extensión Continue instalada desde el marketplace de VSCode
- API key de Routix desde el [dashboard](https://routix.web.id/dashboard)
- Routix ejecutándose (local o en la nube)
...
### 2. Agregar configuración de modelo de Routix
...
```json
{
  "models": [
    ...
    {
      "title": "Routix - Claude Sonnet (Balanced)",
      "provider": "openai",
    ...
    {
      "title": "Routix - DeepSeek Chat (Code)",
      "provider": "openai",
    ...
    {
      "title": "Routix - Claude Haiku (Fast)",
      "provider": "openai",
...
```json
"apiBase": "https://routix.web.id/v1"
```
...
3. Elige tu modelo preferido de Routix
...
- Verifica que Routix esté corriendo: `curl http://localhost:20128/health`
...
- Selecciona el modelo correcto de Routix
...
- Verifica la latencia de red hacia Routix
