...
Routix es compatible con cualquier herramienta que soporte el formato de API de OpenAI. Esta guía cubre patrones de integración genéricos para varias herramientas y aplicaciones personalizadas.

## Resumen

Routix proporciona un endpoint de API compatible con OpenAI que funciona con:
...
Cualquier herramienta compatible con OpenAI puede conectarse a Routix usando estas configuraciones:

**Routix local:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de Routix (cc/*, cx/*, glm/*, etc.)
```

**Routix en la nube:**
```
Base URL: https://routix.web.id/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de Routix (cc/*, cx/*, glm/*, etc.)
```
...
**Problema:** No se puede conectar a Routix
```bash
# Verifica si Routix está corriendo
...
**Solución:**
- Verifica que Routix esté corriendo
...
- Verifica la conexión de red a Routix
