...
Triển khai Routix trên VPS hoặc Docker để truy cập từ xa và dùng trong production.
...
| `DATA_DIR` | `~/.routix` | Đường dẫn lưu database và data |
...
Tạo `/etc/nginx/sites-available/routix`:
...
# If NOT using reverse proxy, allow Routix ports
