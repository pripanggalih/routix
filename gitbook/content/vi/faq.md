...
Những câu hỏi phổ biến về Routix.

---

## Routix là gì?

**Routix là bộ định tuyến mô hình AI giúp tối đa hóa giá trị subscription và giảm chi phí.**
...
**Routix dùng chiến lược pricing 3 tầng:**
...
## Routix có miễn phí không?

**Có, Routix hoàn toàn miễn phí và mã nguồn mở 100%.**
...
**Có! Đây là tính năng cốt lõi của Routix.**
...
**Routix theo dõi quota thời gian thực cho tất cả provider:**
...
## Tôi có thể self-host Routix không?

**Có! Routix hỗ trợ nhiều tùy chọn deployment:**
...
- `DATA_DIR` - Đường dẫn lưu database (mặc định: `~/.routix`)
...
**Có, Routix ưu tiên bảo mật và quyền riêng tư:**

**Local storage:**
- Mọi dữ liệu lưu cục bộ tại `~/.routix` (hoặc `DATA_DIR` tùy chỉnh)
- Không gửi data đến server Routix
...
## Làm thế nào để cập nhật Routix?
...
**Breaking changes:**
- Xem [CHANGELOG.md](https://github.com/pripanggalih/routix/blob/main/CHANGELOG.md)
- Backup `~/.routix` trước khi update lớn
...
Xem [CONTRIBUTING.md](https://github.com/pripanggalih/routix/blob/main/CONTRIBUTING.md) để biết chi tiết.
