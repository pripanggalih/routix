...
Tích hợp Routix với extension Continue để mang trợ lý AI trực tiếp vào Visual Studio Code.

## Yêu cầu

- Visual Studio Code đã cài đặt
- Extension Continue đã cài đặt từ VSCode marketplace
- Routix API key từ [dashboard](https://routix.web.id/dashboard)
- Routix đang chạy (cục bộ hoặc cloud)
...
- Kiểm tra Routix đang chạy: `curl http://localhost:20128/health`
...
- Kiểm tra độ trễ network đến Routix
