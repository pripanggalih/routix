...
Tích hợp Routix với Roo AI Assistant để truy cập nhiều model AI qua một giao diện thống nhất.
...
Chọn từ các model Routix có sẵn:
...
### Connection Failed
- Xác minh Routix đang chạy: `curl http://localhost:20128/health`
