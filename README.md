<div align="center">
  <img src="./images/routix.png?1" alt="Routix Dashboard" width="800"/>
  
  # Routix - FREE AI Router & Token Saver
  ...
  **Connect All AI Code Tools (Claude Code, Cursor, Antigravity, Copilot, Codex, Gemini, OpenCode, Cline, OpenClaw...) to 40+ AI Providers & 100+ Models.**
  ...
  [🚀 Quick Start](#-quick-start) • [💡 Features](#-key-features) • [📖 Setup](#-setup-guide) • [🌐 Website](https://routix.web.id)
...
This repository package is private (`routix-app`), so source/Docker execution is the expected local development path.
...
<table>
  <tr>
    <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=raEyZPg5xE0">
        <img src="https://img.youtube.com/vi/raEyZPg5xE0/maxresdefault.jpg" alt="Routix Setup Tutorial" width="300"/>
      </a><br/>
      <b>🇺🇸 English</b><br/>
      <sub>Routix + Claude Code FREE Setup<br/>by <a href="https://www.youtube.com/@BuildAIWithHamid">Build AI With Hamid</a></sub>
    </td>
    <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=X69n5Lm06Yw">
        <img src="https://img.youtube.com/vi/X69n5Lm06Yw/maxresdefault.jpg" alt="Tiết kiệm chi phí LLM với Routix" width="300"/>
      </a><br/>
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Tiết kiệm chi phí LLM cho OpenClaw với Routix<br/>by <a href="https://www.youtube.com/c/M%C3%ACAIblog">Mì AI</a></sub>
    </td>
    <td align="center" width="320">
  ...
  <tr>
    <td align="center" width="320">
      ...
      <b>🇺🇸 English</b><br/>
      <sub>Claude CLI Free Setup with Routix 🚀<br/>by <a href="https://www.youtube.com/@CodeVerseSoban">CodeVerse Soban</a></sub>
    </td>
    <td align="center" width="320">
      ...
      <b>🇻🇳 Tiếng Việt</b><br/>
      <sub>Cài Đặt OpenClaw Free Từ A-Z + Routix<br/>by <a href="https://www.youtube.com/@maigia">Mai Gia</a></sub>
    </td>
    <td align="center" width="320">
  ...
  <tr>
    <td align="center" width="320">
      ...
      <b>🇮🇩 Indonesia</b><br/>
      <sub>Koding 24 Jam Anti Rate Limit! Hemat Token AI 65% | Tutorial Quick Setup Routix 🚀<br/>by <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
    <td align="center" width="320">
      <a href="https://www.youtube.com/watch?v=TXGv4eofe1I">
        <img src="https://img.youtube.com/vi/TXGv4eofe1I/mqdefault.jpg" alt="Cara Deploy Routix di Hugging Face GRATIS Non-Stop! | Alternatif VPS RAM 16GB" width="300"/>
      </a><br/>
      <b>🇮🇩 Indonesia</b><br/>
      <sub>Cara Deploy Routix di Hugging Face GRATIS Non-Stop! | Alternatif VPS RAM 16GB<br/>by <a href="https://www.youtube.com/@krisswuh">Krisswuh</a></sub>
    </td>
  </tr>
</table>
...
> 🎬 **Made a video about Routix?** Submit a [Pull Request](https://github.com/pripanggalih/routix/pulls) adding your video to this section — we'll merge it!

---

## 🛠️ Supported CLI Tools

Routix works seamlessly with all major AI coding tools:
...
Headroom is optional and runs separately. Routix calls Headroom's local `/v1/compress` endpoint, then keeps normal routing, fallback, auth, and usage tracking:

```
Client → Routix → Headroom /v1/compress → Routix → provider
```
...
If Headroom is down or returns an error, Routix fails open and sends the original request.
...
- Your CLI tool sends OpenAI format → Routix translates → Provider receives native format
...
> Routix itself **never charges** you anything. You only pay providers directly (if using paid services).
> 
...
### 📊 Understanding Routix Costs & Billing

**Routix Billing Reality:**

✅ **Routix software = FREE forever** (open source, never charges)  
✅ **Dashboard "costs" = Display/tracking only** (not actual bills)  
✅ **You pay providers directly** (subscriptions or API fees)  
✅ **FREE providers stay FREE** (iFlow, Kiro, Qwen = $0 unlimited)  
❌ **Routix never sends invoices** or charges your card
...
- **Cheap providers** (GLM, MiniMax): Pay them directly, Routix just routes
- **FREE providers** (iFlow, Kiro, Qwen): Genuinely free forever, no hidden charges
- **Routix**: Never charges anything, ever
...
The dashboard tracks your token usage and displays **estimated costs** as if you were using paid APIs directly. This is **not actual billing** - it's a reference to show how much you're saving by using free models or existing subscriptions through Routix.
...
<details>
<summary><b>💳 Will I be charged by Routix?</b></summary>

**No.** Routix is free, open-source software that runs on your own computer. It never charges you anything.

**You only pay:**
- ✅ **Subscription providers** (Claude Code $20/mo, Codex $20-200/mo) → Pay them directly on their websites
- ✅ **Cheap providers** (GLM, MiniMax) → Pay them directly, Routix just routes your requests
- ❌ **Routix itself** → **Never charges anything, ever**

Routix is a local proxy/router. It doesn't have your credit card, can't send invoices, and has no billing system. It's completely free software.
...
Routix just routes your requests to them - there's no "catch" or future billing. They're truly free services, and Routix makes them easy to use with fallback support.
...
3. **Use subscription providers last:**
   ...
   - Routix helps maximize their value through quota tracking
...
Routix's smart fallback prevents surprise charges:
...
**You're in control:** Set spending limits per provider in dashboard, and Routix respects them.
...
**Pro Tip:** Use Opus for complex tasks, Sonnet for speed. Routix tracks quota per model!
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [from routix dashboard]
...
```json
{
  ...
  "anthropic_api_key": "your-routix-api-key"
}
```
...
export OPENAI_API_KEY="your-routix-api-key"
...
```json
{
  "agents": {
    "defaults": {
      "model": {
        "primary": "routix/kr/claude-sonnet-4.5"
      }
    }
  },
  "models": {
...
> **Note:** OpenClaw only works with local Routix. Use `127.0.0.1` instead of `localhost` to avoid IPv6 resolution issues.
...
```bash
# Clone and install
git clone https://github.com/pripanggalih/routix.git
cd routix
npm install
npm run build
...
export DATA_DIR="/var/lib/routix"
export PORT="20128"
export HOSTNAME="0.0.0.0"
export NODE_ENV="production"
export NEXT_PUBLIC_BASE_URL="http://localhost:20128"
export NEXT_PUBLIC_CLOUD_URL="https://routix.web.id"
...
# Or use PM2
npm install -g pm2
pm2 start npm --name routix -- start
pm2 save
pm2 startup
```
...
- GHCR: [`ghcr.io/decolua/routix`](https://github.com/pripanggalih/routix/pkgs/container/routix)
...
docker run -d --name routix -p 20128:20128 \
  -v "$HOME/.routix:/app/data" -e DATA_DIR=/app/data routix
```
...
docker restart routix
docker stop routix && docker rm routix
docker pull decolua/routix:latest   # update to latest
```

**Data persistence:** `$HOME/.routix/db/data.sqlite` on host ↔ `/app/data/db/data.sqlite` in container.

### Environment Variables

| Variable | Default | Description |
|----------|---------|-------------|
| `JWT_SECRET` | Auto-generated (`~/.routix/jwt-secret`) | JWT signing secret for dashboard auth cookie (override to share across instances) |
| `INITIAL_PASSWORD` | `123456` | First login password when no saved hash exists |
| `DATA_DIR` | `~/.routix` | Main app data location (SQLite at `$DATA_DIR/db/data.sqlite`) |
| `PORT` | framework default | Service port (`20128` in examples) |
| `HOSTNAME` | framework default | Bind host (Docker defaults to `0.0.0.0`) |
| `NODE_ENV` | runtime default | Set `production` for deploy |
| `BASE_URL` | `http://localhost:20128` | Server-side internal base URL used by cloud sync jobs |
| `CLOUD_URL` | `https://routix.web.id` | Server-side cloud sync endpoint base URL |
| `NEXT_PUBLIC_BASE_URL` | `http://localhost:3000` | Backward-compatible/public base URL (prefer `BASE_URL` for server runtime) |
| `NEXT_PUBLIC_CLOUD_URL` | `https://routix.web.id` | Backward-compatible/public cloud URL (prefer `CLOUD_URL` for server runtime) |
...
- Both `${DATA_DIR}` and `~/.routix` resolve to the same location in a Docker container — the symlink `/root/.routix -> /app/data` is created at build time.
...
- **Website**: [routix.web.id](https://routix.web.id)
- **GitHub**: [github.com/pripanggalih/routix](https://github.com/pripanggalih/routix)
- **Issues**: [github.com/pripanggalih/routix/issues](https://github.com/pripanggalih/routix/issues)

---

## 👥 Contributors

Thanks to all contributors who helped make Routix better!

[![Contributors](https://contrib.rocks/image?repo=decolua/routix&max=150&columns=15&anon=1&v=20260309)](https://github.com/pripanggalih/routix/graphs/contributors)

---

## 📊 Star Chart

[![Star Chart](https://starchart.cc/decolua/routix.svg?variant=adaptive)](https://starchart.cc/decolua/routix)



## 🔀 Forks

**[OmniRoute](https://github.com/diegosouzapw/OmniRoute)** — A full-featured TypeScript fork of Routix. Adds 36+ providers, 4-tier auto-fallback, multi-modal APIs (images, embeddings, audio, TTS), circuit breaker, semantic cache, LLM evaluations, and a polished dashboard. 368+ unit tests. Available via npm and Docker.
...
- **[RTK](https://github.com/rtk-ai/rtk)** ![Stars](https://img.shields.io/github/stars/rtk-ai/rtk?style=flat&color=yellow) — Rust token-saver. Routix ports its compression pipeline to JS → **−20-40% input tokens** on every request.
- **[Caveman](https://github.com/JuliusBrussee/caveman)** ![Stars](https://img.shields.io/github/stars/JuliusBrussee/caveman?style=flat&color=yellow) by **[@JuliusBrussee](https://github.com/JuliusBrussee)** — viral *"why use many token when few token do trick"*. Routix adapts its prompt → **−65% output tokens**.
- **[Ponytail](https://github.com/DietrichGebert/ponytail)** ![Stars](https://img.shields.io/github/stars/DietrichGebert/ponytail?style=flat&color=yellow) by **[@DietrichGebert](https://github.com/DietrichGebert)** — *"lazy senior dev"* skill. Routix injects its YAGNI-first ladder → **fewer tokens, less code, shorter diffs**.

Huge thanks to these authors — without their work, Routix's token-saving features wouldn't exist. ⭐ them on GitHub!
