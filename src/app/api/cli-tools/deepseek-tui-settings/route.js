...
// Build TOML config for Routix (openai provider mode)
const buildRoutixConfig = (baseUrl, apiKey, model) => {
...
// Detect Routix by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildRoutixConfig(baseUrl, apiKey || "sk_routix", model);
